...
class AuthUserController extends Controller
{
    ...
    public function sociallogin(Request $request)
    {
        ...
        $userExist = AuthUser::where('email', $request['email'])->first();
        ...
        if ($userExist) {
            ...
            if ($userExist->save()) {
                ...
                return response()->json([
                    'accessToken' => $userExist->createToken('api_token')->plainTextToken,
                    'token_type' => 'Bearer',
                    'user' => $userExist,
                ], 200);
            }
            ...
            // $token = $userExist->createToken('Personal Access Token')->plainTextToken;
            ...
            $user = new AuthUser([
                ...
                'socialID' => bcrypt($request->password), // Hash the password for security
            ]);
